 ...
 *
 * Client component for database cleanup interface
...
export function CleanupUI({ userEmail }: CleanupUIProps) {
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <p className="mt-3 text-xs text-blue-700">
            Note: This endpoint is only available in development mode and
